    ...
    return (
      <SafeAreaView style={styles.centerContainer}>
        ...
        <Text style={styles.errorText}>
          {errors.general || "Không tìm thấy món ăn"}
        </Text>
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.imageWrapper}>
          ...
          <TouchableOpacity style={styles.iconButtonLeft} onPress={onBack}>
            <Ionicons name="chevron-back" size={22} color="#5F8F1F" />
          </TouchableOpacity>
        ...
        <View style={styles.content}>
          ...
          {!!errors.general && (
            <Text style={styles.errorTextInline}>{errors.general}</Text>
          )}
