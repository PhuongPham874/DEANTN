...
class UserContextIntentService:
    INTENT_PATTERNS = {
        ...
        "inventory": [
            ...
            r"\btủ lạnh của tôi\b.*\b(có gì|còn gì)\b",
            r"\btôi còn\b.*\b(thịt|rau|cá|trứng|gia vị|nguyên liệu)\b",
            r"\btrong kho của tôi\b.*\b(có gì|còn gì)\b",
        ...
        "shopping": [
            r"\bdanh sách mua sắm của tôi\b",
            r"\bshopping list\b",
            r"\btôi cần mua gì\b",
            r"\bđã mua gì trong danh sách mua sắm của tôi\b",
            r"\bchưa mua trong danh sách mua sắm của tôi\b",
            r"\bcòn thiếu gì trong danh sách mua sắm của tôi\b",
            r"\bdanh sách mua sắm gần nhất trong danh sách mua sắm của tôi\b",
        ],
        "cook_suggestion": [
        ...
        "shopping_inventory_compare": [
            r"\bdanh sách mua sắm của tôi\b.*\bkho\b",
            r"\bkho\b.*\bdanh sách mua sắm của tôi\b",
            r"\bcòn thiếu gì so với danh sách mua sắm của tôi\b",
            r"\bđã có sẵn gì trong kho\b",
        ],
        "favorite_inventory_match": [
            r"\bmón yêu thích của tôi\b.*\bkho\b",
